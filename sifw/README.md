...
Agora em ambos os servidores, no jboss-cli execute o seguinte:
	...
	$ module add --name=org.postgresql --resources=/opt/postgresql-42.2.23.jar  --dependencies=jakarta.api,jakarta.transaction.api
...
ATENÇÃO! somento no wildfly app
	...
	$ /subsystem=datasources/data-source=baseDS:add(driver-name=postgresql,jndi-name="java:jboss/datasources/baseDS",connection-url="jdbc:postgresql://localhost:5432/base",user-name=USER, password=12345678)
